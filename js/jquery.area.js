...
var  newprovince,newcity,newarea;
/*初始化省份*/
...
function changPrice(){
	if(newprovince=='黑龙江省'){
		if(newarea=='香坊区'||newarea=='平房区'||newarea=='道里区'||newarea=='道外区'||newarea=='南岗区'||newarea=='松北区'){
			$(".additional").text(0)
		}else{
			$(".additional").text(15)
		}
	...
	var additional = $(".additional").text();
	$(".totalNum").text(price*1+additional*1)
}
$(function() {
	var price = $(".price").text();
	var additional = $(".additional").text();
